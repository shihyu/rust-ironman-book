...
- 原文連結：https://ithelp.ithome.com.tw/articles/10266765
- 章節：DAY 10
- 發佈時間：2021-09-18 12:30:16
- 作者：Ken
- 清單瀏覽數：842
- 清單摘要：利用布林值來決定如何繼續執行程式進行決策 例 let n = 3; if n > 2 { println!("執行") }...
...
if
跟其他語言差不多，if關鍵字後面布林求值稱為條件只有當true才會執行大括號裡面的語法
...
═══════════════════════════════════════════
              ...
              v               v
        ┌───────────┐   ┌─────────────┐
        │ branch_1  │   │ cond_2 ?    │   ← true 走左，false 繼續
        └───────────┘   └──────┬──────┘
                               │
                       ┌───────┴──────┐
                       │              │
