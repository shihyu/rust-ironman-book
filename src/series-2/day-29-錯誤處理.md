...
- 原文連結：https://ithelp.ithome.com.tw/articles/10278316
- 章節：DAY 29
- 發佈時間：2021-10-07 08:53:23
- 作者：Ken
- 清單瀏覽數：1571
- 清單摘要：Rust將錯誤分成兩大類 不可復原的(unrecoverable) 可復原的(recoverable) 至於什麼時候該用什麼樣的錯誤就要看使用情境了 例如程...
...
─────────────── 可復原錯誤 ─────────────────────
  ...
  ┌────────────────────────────────┐
  │ fn read() -> Result<T, E>      │     ← 回傳 Result 型別
  └───────────────┬────────────────┘
                  │
          ┌───────┴───────┐
          │               │
