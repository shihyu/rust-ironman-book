...
- 原文連結：https://ithelp.ithome.com.tw/articles/10262073
- 章節：DAY 03
- 發佈時間：2021-09-14 08:41:44
- 作者：Ken
- 清單瀏覽數：1466
- 清單摘要：Rust是靜態型別語言，所以在編譯時需要知道變數的型別是什麼 前面的程式範例很多是沒有宣吿型別但是卻可以編譯，這邊用到的是透過 通常編譯器能通過數值來推導型別是...
...
Rust預設整數型別是i32  
![](images/day-03-rust-資料型別-整數-浮點數/img-001.png)
