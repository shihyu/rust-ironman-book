...
- 原文連結：https://ithelp.ithome.com.tw/articles/10268285
- 章節：DAY 12
- 發佈時間：2021-09-20 11:57:54
- 作者：Ken
- 清單瀏覽數：1045
- 清單摘要：如果想印出1到100的數字，更常的做法是使用for迴圈而不是while 例 for i in 1..101 { println!("{}&qu...
...
┌────────────┐     next()     ┌────────────────┐
│ collection │ ─────────────> │ Iterator state │  ← 持有迭代位置
└────────────┘                └────────┬───────┘
                                       │
                             Some(item)│None      ← match 分支
                                       v
                                 body / break
```
