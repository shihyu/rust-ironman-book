...
- 原文連結：https://ithelp.ithome.com.tw/articles/10264963
- 章節：DAY 08
- 發佈時間：2021-09-16 09:29:53
- 作者：Ken
- 清單瀏覽數：1383
- 清單摘要：Rust的char型別是最基本的字母型別，用單引號包起來 例 let a = 'b'; Rust的字串分兩種 str String 嚴格來講Rust在核心...
...
char ('中')
┌───────────────────────┐
│ 4 bytes Unicode scalar │                ← 固定 4 bytes
│ U+4E2D                │
└───────────────────────┘
