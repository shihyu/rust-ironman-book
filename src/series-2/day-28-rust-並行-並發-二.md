...
- 原文連結：https://ithelp.ithome.com.tw/articles/10278240
- 章節：DAY 28
- 發佈時間：2021-10-06 09:54:49
- 作者：Ken
- 清單瀏覽數：1087
- 清單摘要：channel 通常channel都是搭配並行使用，沒有使用並行就沒有使用channel的意義「別透過共享記憶體來溝通，而是透過溝通來共享記憶體」。沒錯Gola...
...
─────────────── 特性 ───────────────────────────
  ...
  - send(v) 會移動所有權到 channel  ← 原 owner 不可再使用
