...
- 作者：Ken
- 清單瀏覽數：4516
- 清單摘要：分享一下這30天從無到有的學習下來的一點點心得先說一下為什麼要學習Rust是因為最近比較紅之外還有就是它滿常被拿來跟Golang比較身為一個Gopher當然要抱...

## 內文

分享一下這30天從無到有的學習下來的一點點心得  
先說一下為什麼要學習Rust是因為最近比較紅之外還有就是它滿常被拿來跟Golang比較  
...
```text
30 天 Rust 學習地圖（核心能力堆疊）

Phase 1: 語法基礎
- 變數 / 型別 / 控制流 / 函式

Phase 2: 資料模型
- struct / enum / match / 泛型 / trait

Phase 3: 記憶體與安全
- ownership / borrow / move / 生命周期概念
